...
def load_datasets():
    ...
    # Defensive RGB normalization (same as EfficientNet)
...
def build_resnet_model(num_classes):
    ...
    model = keras.Model(inputs, outputs, name="resnet50_ham10000")
...
def main():
    ...
    callbacks = [
        keras.callbacks.ModelCheckpoint(
            filepath=MODEL_DIR / "resnet50_ham10000_best.keras",
            monitor="val_loss",
            save_best_only=True,
            verbose=1,
        ),
    ...
    curve_path = CURVES_DIR / "resnet50_training_curves.jpg"
    plt.tight_layout()
    ...
    report_path = REPORTS_DIR / "resnet50_classification_report.txt"
    ...
    cm_path = CM_DIR / "resnet50_confusion_matrix.jpg"
    plt.tight_layout()
    plt.savefig(cm_path)
    plt.close()
    ...
    model_path = MODEL_DIR / "resnet50_ham10000.keras"
